...
export default function AdminDashboard() {
    const [stats, setStats] = useState([
        { label: "Pending", value: 0, color: "#f59e0b", icon: "⏳", href: "/admin/suppliers" },
        { label: "Suppliers", value: 0, color: "#22c55e", icon: "🏭", href: "/admin/suppliers" },
        { label: "Flagged", value: 0, color: "#ef4444", icon: "🚩", href: "/admin/buyers" },
        { label: "Inquiries", value: 0, color: "#3b82f6", icon: "📬", href: "/admin/logs" },
    ]);
    ...
    const fetchDashboardData = async () => {
        try {
            ...
            if (res.ok) {
                setStats([
                    { label: "Pending", value: data.stats.pendingSuppliers, color: "#f59e0b", icon: "⏳", href: "/admin/suppliers" },
                    { label: "Suppliers", value: data.stats.totalSuppliers, color: "#22c55e", icon: "🏭", href: "/admin/suppliers" },
                    { label: "Flagged", value: data.stats.flaggedBuyers, color: "#ef4444", icon: "🚩", href: "/admin/buyers" },
                    { label: "Inquiries", value: data.stats.recentInquiries, color: "#3b82f6", icon: "📬", href: "/admin/logs" },
                ]);
